function InitGame()
{
	InitGraphics(128, 128, "gc_tiles.png");
	...
	InitMap(16, 16, ["Ground", "Tile", "Object", "Item", "Unit"]);
	...
	// Units
	AddBlueprint("@", ["Hero", "Unit", "Position", "Action", "Speed", "Map", "Movement"], {Sprite: 4, Control: "input", Health: {value: 3, max: 3}, Attack: 1, Defend: 0});
	AddBlueprint("S", ["AI", "Unit", "Position", "Action", "Speed", "Map", "Movement", "HUD"], {Sprite: 20, Control: "ai", Health: {value: 3, max: 3}, Attack: 1, Drop: 'M'});
	AddBlueprint("B", ["AI", "Unit", "Position", "Action", "Speed", "Map", "Movement", "HUD"], {Sprite: 13, Control: "ai", Health: {value: 4, max: 4}, Attack: 2, Drop: 'D'});
	...
	// Items
	AddBlueprint("H", ["Map"], {Sprite: 138, Item: {component: "Health", param: "value", value: 2}});
	AddBlueprint("M", ["Map"], {Sprite: 171, Item: {component: "Health", param: "max", value: 1}});
...
function DrawHeroUISystem(entity)
{
	...
	DrawTile(169, 12 * 8, 0);
	DrawTile(160 + entity.Attack, 13 * 8, 0);
	DrawTile(170, 14 * 8, 0);
	DrawTile(160 + entity.Defend, 15 * 8, 0);
}
